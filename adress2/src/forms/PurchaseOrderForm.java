...
public class PurchaseOrderForm extends org.apache.struts.action.ActionForm {
    ...
    public PurchaseOrderForm(Integer id, String ponumber, String status, String priority, String poissuedate, String duedate,
                             String seller, String transresp, String incoterms, String billto, String designatedmode,
                             String carrier, String shiptogether, String shipfrom, String originstreet, String origincity,
                             String originstate, String origincountry, String pickupstart, String pickupend, String shipto,
                             String destinationstreat, String destinationcity, String destinationstate, String destinationcountry,
                             String deliverystart, String deliveryend) {
        this.id = id;
        this.ponumber = ponumber;
        this.status = status;
        this.priority = priority;
